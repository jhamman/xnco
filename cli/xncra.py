...
@click.option('--record-dim', type=str, default=None,
              help='Record dimension')
...
def main(in_nc, out_nc, record_dim, dask_scheduler, log_level):
    ...
    # the guts of ncra
    ds = xr.open_mfdataset(in_nc)
    out = ds.mean(dim=record_dim)
